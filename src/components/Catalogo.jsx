...
const Catalogo = () => {
  return (
    <div className="flex flex-col justify-start items-center h-[550px] w-full bg-[#F3F4F6] pt-20">
      ...
      <div className="flex flex-row justify-center items-center mt-10 w-full pb-10">
        {productos.map((producto, index) => (
          <div
            key={index}
            className="bg-[#F9FAFB] w-[300px] h-[250px] rounded-md mx-5 shadow-lg shadow-black/30 bg-black/90 flex flex-col justify-between items-center hover:scale-105 cursor-pointer hover:shadow-blue-950 transition-transform duration-300"
          >
